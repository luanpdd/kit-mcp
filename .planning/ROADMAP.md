...
(nada — v1.20.0 concluído. Pronto para `/novo-marco` v1.21+)
...
- **v1.20.0 — Tech Debt Closure & Quality Hardening (Phases 100-105)** — 6 REQs, 89 tests, 671 baseline. PRR **30/30**. Coverage 81.51→86.84%. Mutation baseline 57.40%. Multi-window burn-rate. RUNBOOK 5→9 scenarios. Kit cache pre-warm (M4 p95 144→0ms). [Audit](./milestones/v1.20-MILESTONE-AUDIT.md) · [Roadmap](./milestones/v1.20-ROADMAP.md)
