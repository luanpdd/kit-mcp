...
Construir a URL pública da nota no GitHub:

```
OBSIDIAN_URL = https://github.com/IEP-Advocacia/obsidian-chat-trynux/blob/main/01%20-%20PRs/YYYY/YYYY-MM-DD-pr-{PR_NUMBER}-{slug}.md
```
